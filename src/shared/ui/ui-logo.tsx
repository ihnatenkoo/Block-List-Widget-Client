...
const ShieldIcon = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <path
        fill="#728084"
        d="M35.8 23.7h17.9C53.3 14.9 50.4 9 50.4 9s-5.6.8-9.5 0c-1.8-.4-3.6-1.2-5.1-2.1zm-7.6 0V6.9c-1.4.9-3.2 1.7-5 2.1c-4 .8-9.5 0-9.5 0s-3 5.9-3.3 14.7zm0 7.4H10.6c.1.4.1.8.2 1.2C12.6 43.6 22.7 53 28.2 57.4zm7.6 0v26.3c5.6-4.4 15.6-13.8 17.4-25.1c.1-.4.1-.8.2-1.1z"
      />
      <path
        fill="#b0bdc6"
        d="M36.5 22.7h17.9C54.1 13.9 51.2 8 51.2 8s-5.6.8-9.5 0c-1.9-.3-3.7-1.2-5.2-2zm-9 0V6c-1.5.8-3.3 1.7-5.1 2c-4 .8-9.5 0-9.5 0s-3 5.9-3.3 14.7zm0 9.1H9.8c.1.4.1.8.2 1.1C11.9 44.2 21.9 53.6 27.5 58zm9 0V58c5.6-4.4 15.6-13.8 17.4-25.1c.1-.4.1-.8.2-1.1z"
        opacity=".3"
      />
